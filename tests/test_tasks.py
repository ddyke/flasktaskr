...
class AllTests(unittest.TestCase):
    ...
    def test_users_cannot_see_task_modify_links_for_tasks_not_created_by_them(self):
        ...
        self.create_user('testuser2', 'test2@gmail.com', 'testtest2')
        self.login('testuser2', 'testtest2')
        response = self.app.get('tasks/', follow_redirects=True)
    ...
    def test_admin_users_can_see_task_modify_links_for_tasks_created_by_them(self):
        self.create_user('testuser1', 'test1@gmail.com', '111111')
        self.login('testuser1', '111111')
        self.app.get('tasks/', follow_redirects=True)
        self.create_task()
